...
const Home = async ({ params }: { params: { lang: Locale } }) => {
	...
	return (
		<div>
			...
			<div className="container mx-auto flex justify-center">
				<div className="bg-gradient-to-br from-[#fad0c4] to-[#ffd1ff] 2xl:h-[35rem] rounded-2xl flex flex-col 2xl:flex-row">
			...
			{/* <div className="text-center lg:my-12 my-8">
				<p className="text-4xl md:text-5xl lg:text-6xl font-bold">
					Explore our Products
				</p>
			</div>
			<div className="lg:h-[70rem] bg-black">
				<Categories />
			</div>
			<div>
				<Perks />
